...
declare namespace __next_route_internal_types__ {
  ...
  type DynamicRoutes<T extends string = string> = 
    | `/admin/consolidated-reports/${SafeSlug<T>}`
    | `/admin/reports/${SafeSlug<T>}`
    | `/admin/team-types/${SafeSlug<T>}/edit`
    | `/admin/users/${SafeSlug<T>}`
    | `/admin/users/${SafeSlug<T>}/edit`
    | `/api/admin/team-types/${SafeSlug<T>}`
    | `/api/consolidated-reports/${SafeSlug<T>}`
    | `/api/consolidated-reports/${SafeSlug<T>}/finalize`
    ...
    | `/report-manager/users/${SafeSlug<T>}/edit`
