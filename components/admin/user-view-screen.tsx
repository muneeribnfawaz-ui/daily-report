        ...
        {query.isLoading ? (
          ...
          <>
            ...
            <div className="grid gap-3 md:grid-cols-2">
              ...
              <div className="rounded-xl border bg-background/70 p-4">
                <div className="text-xs uppercase tracking-[0.2em] text-muted-foreground">Secondary Phone</div>
                <div className="mt-1 text-sm font-medium">{user.secondaryPhone ?? "—"}</div>
              </div>
              <div className="rounded-xl border bg-background/70 p-4">
                <div className="text-xs uppercase tracking-[0.2em] text-muted-foreground">Date of Birth</div>
