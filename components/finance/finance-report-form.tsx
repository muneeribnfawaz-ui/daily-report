    ...
    return (
      <div className="overflow-hidden rounded-xl border border-cardBorder bg-card shadow-soft mb-6">
        <div className="flex items-center justify-between border-b bg-gradient-to-r from-slate-900 to-slate-800 px-4 py-3 text-white">
          ...
          <Button type="button" variant="ghost" size="sm" onClick={() => append({ particulars: "", description: "", amountINR: 0, amountSAR: 0 })} className="h-8 text-white hover:text-slate-900 bg-white/20 hover:bg-white/90">
            <Plus className="h-4 w-4 mr-1" /> Add Row
          </Button>
        </div>
        <div className="p-0 overflow-x-auto">
          <div className="grid grid-cols-[1.2fr_1.8fr_1fr_1fr_40px] gap-2 px-4 py-2 bg-muted/30 text-sm font-semibold border-b min-w-[750px]">
            <div>Particulars</div>
            <div>Description</div>
          ...
          {fields.map((field, index) => {
            ...
            return (
              <div key={field.id} className="grid grid-cols-[1.2fr_1.8fr_1fr_1fr_40px] gap-2 px-4 py-2 items-center border-b last:border-0 min-w-[750px]">
                <Input {...register(`${namePrefix}.${index}.particulars`)} placeholder="Enter particulars" className="h-9" />
                <Input {...register(`${namePrefix}.${index}.description`)} placeholder="Payment description / details" className="h-9" />
          ...
          {fields.length > 0 && (
            <div className="grid grid-cols-[1.2fr_1.8fr_1fr_1fr_40px] gap-2 px-4 py-3 bg-muted/10 font-bold items-center min-w-[750px]">
