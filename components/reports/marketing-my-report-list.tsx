...
interface MarketingMyReportListProps {}

export function MarketingMyReportList({}: MarketingMyReportListProps) {
                  ...
                  <div key={reportId} className="grid grid-cols-1 gap-3 px-4 py-4 text-sm md:grid-cols-12">
                    ...
                    <div className={`flex flex-wrap gap-2 ${hideTeamAndType ? "md:col-span-4" : "md:col-span-3"}`}>
                      <Button asChild size="sm" variant="outline" className="h-8">
                        <Link href={`/daily-report/${reportId}/preview` as any}>{t("common.preview")}</Link>
                      </Button>
