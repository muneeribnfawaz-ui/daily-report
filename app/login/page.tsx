    ...
    <div className="min-h-screen bg-background flex flex-col justify-between text-textPrimary transition-colors duration-200">
      ...
      <header className="bg-navbar text-sidebarText px-6 py-4 shadow-md border-b border-primary/20">
        <div className="mx-auto max-w-6xl flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-lg font-bold tracking-tight text-sidebarText">Daily Report System</span>
              <span className="text-xs block text-primary font-medium tracking-wider uppercase">Enterprise Edition</span>
            </div>
          </div>
        ...
        <div className="mx-auto grid max-w-6xl w-full gap-8 lg:grid-cols-[1.1fr_0.9fr] items-stretch">
          ...
          <section className="rounded-3xl border border-primary/20 bg-sidebar p-8 text-sidebarText shadow-2xl lg:p-12 flex flex-col justify-between relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <h1 className="text-3xl font-bold tracking-tight lg:text-5xl leading-tight text-sidebarText">
                Daily reports, approvals, locking, and audit trails in one place.
              </h1>
              ...
              <div className="pt-4 space-y-4 text-sm opacity-90">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <span className="font-semibold text-sidebarText">Consolidated Reporting</span>
                    <p className="text-xs opacity-75">Automated daily report aggregation across company workspaces.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <span className="font-semibold text-sidebarText">Senior Approval Hierarchy</span>
                    <p className="text-xs opacity-75">Structured verification level controls for Team Leads, HODs, and CEOs.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <span className="font-semibold text-sidebarText">Report Locking & PDF Exports</span>
                    <p className="text-xs opacity-75">Tamper-proof date locking with instant PDF documentation generation.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative z-10 pt-8 border-t border-primary/20 flex items-center justify-between text-xs opacity-80">
              ...
              <span className="text-primary font-medium">JWT Authenticated</span>
            </div>
          </section>
          ...
          <Card className="self-center bg-card border border-border shadow-xl rounded-3xl p-2 sm:p-4">
            <CardHeader className="space-y-1.5 pb-4">
              <CardTitle className="text-2xl font-bold tracking-tight text-textPrimary">Sign in</CardTitle>
              <CardDescription className="text-sm text-mutedForeground">
                Access your role-specific management dashboard.
              </CardDescription>
            </CardHeader>
      ...
      <footer className="bg-navbar text-sidebarText px-6 py-4 border-t border-primary/20 text-xs text-center">
        <div className="mx-auto max-w-6xl flex flex-col sm:flex-row items-center justify-between gap-2">
          <span>&copy; {new Date().getFullYear()} Daily Report Management System. All rights reserved.</span>
          <span className="text-primary font-medium">Strict Access Control Enabled</span>
        </div>
      </footer>
    </div>
  );
